...
module github.com/yasvanth511/openllm-metrics-oss/tests/contract/metrics-endpoint

go 1.25.0

require (
	github.com/yasvanth511/openllm-metrics-oss/apps/api/metrics-endpoint v0.0.0
...
require (
	...
	github.com/yasvanth511/openllm-metrics-oss/packages/telemetry/schema-lint/go v0.0.0 // indirect
	go.opentelemetry.io/otel v1.30.0 // indirect
	go.opentelemetry.io/otel/metric v1.30.0 // indirect
	go.opentelemetry.io/otel/trace v1.30.0 // indirect
)

replace github.com/yasvanth511/openllm-metrics-oss/apps/api/metrics-endpoint => ../../../apps/api/metrics-endpoint
